...
<form method="post" action="../vue/scanner.php">
    ...
    <div class="radio-group">
        ...
        <label for="port-list1">Tous les ports TCP (+65500) + top 100 des ports UDP utilisés par <code>nmap</code> <span class="default-option">(option par défaut)</span></label>
    </div>
    <div class="radio-group">
